            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody><?php $no=1; foreach ($data as $b) { ?>
                <tr>
                  ...
                  <td><?= $b['semester'];?></td>
                  <td><?= $b['sks'];?></td>
                  <td><a href="<?= base_url('variabel/edit/'.$b['kode'].'') ?>"><button class="btn btn-warning">Edit Data</button></a>||<a href="" data-toggle="modal" data-target="#modaldemo2"><button class="btn btn-danger">Hapus Data</button></a> 
                    </td>
                </tr><?php $no++; } ?>
              </tbody>
            </table>
