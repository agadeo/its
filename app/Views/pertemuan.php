            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-5p">Pertemuan</th>
                  <th class="wd-20p">Kode QR</th>
              ...
              <tbody><?php $no=1; foreach ($data as $b) { ?>
                <tr>
                  ...
                  <td><?= $b['jenis'];?></td>
                  <td><a href="<?= base_url('pertemuan/view/'.$b['id_pertemuan'].'') ?>"><button class="btn btn-info">View Data</button></a>||<a href="<?= base_url('absen/index/'.$b['id_pertemuan'].'') ?>"><button class="btn btn-info">Absen</button></a> 
                    </td>
                </tr><?php $no++; } ?>
              </tbody>
            </table>
