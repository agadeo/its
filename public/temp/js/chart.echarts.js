$(function(){
  ...
  var chartdata = [
    {
      name: 'Indeks Kerawanan Kemiskinan',
      type: 'bar',
      data: [10.86, 10.62]
    },
    {
      name: 'Indeks Kerawanan Keamanan dan Ketertiban',
      type: 'bar',
      data: [10.38, 10.30]
    },
    {
      name: 'Indeks Kerawanan Lingkungan',
      type: 'bar',
      data: [63.50, 63.50]
    }
  ];
  ...
  var pieData = [{
    ...
    center: ['50%', '50%'],
    data: [
      {value: 0.9, name: 'Laju Pertumbuhan Penduduk'},
      {value: 0.5, name: 'Angka Pengangguran'},
      {value: 0.75, name: 'Tingkat Pendidikan'},
      {value: 0.63, name: 'Bencana Alam'},
      {value: 0.58, name: 'Distribusi Pendapatan'}
    ],
    label: {
      normal: {
  ...
  var donutData = [{
    ...
    center: ['50%', '57.5%'],
    data: [
      {value: 335, name: 'Laju pertumbuhan penduduk'},
      {value: 310, name: 'Angka pengangguran'},
      {value: 234, name: 'Tingkat pendidikan'},
      {value: 135, name: 'Bencana alam'},
      {value: 154, name: 'Distribusi pendapatan'}
    ],
    label: {
      normal: {
        fontFamily: 'Roboto, sans-serif',
