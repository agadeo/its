    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        <div class="br-section-wrapper">
          <h6 class="br-section-label">Data Mahasiswa</h6>
            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody><?php $no=1; foreach ($data as $b) { ?>
                <tr>
                  ...
                  <td><a href="<?= base_url('variabel/edit/'.$b['nama'].'') ?>"><button class="btn btn-warning">Edit Data</button></a>||<a href="" data-toggle="modal" data-target="#modaldemo2"><button class="btn btn-danger">Hapus Data</button></a> 
                    </td>
                </tr><?php $no++; } ?>
              </tbody>
            </table>
            ...
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
              <div class="modal-content bd-0 tx-14">
                ...
                <div class="modal-footer justify-content-center">
                  <a href="<?= base_url('variabel/hapus/'.$b['nama'].'') ?>"><button type="button" class="btn btn-danger tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium">Hapus</button></a>
